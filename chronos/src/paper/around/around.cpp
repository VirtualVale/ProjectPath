...
int main(int argc, char** argv){
  ...
  list_goals[0] = {3, 1.5, 0, 0};
  list_goals[1] = {3, 1.5, 0, 0};
  list_goals[2] = {3, 1.5, 0, 0};
  list_goals[3] = {3, 1.5, 0, 0};
  list_goals[4] = {3, 1.5, 0, 0};
  ...
  ROS_ERROR("Robot1: driveAround-strategy time_sum %f", time_sum.toSec());
