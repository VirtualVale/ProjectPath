...
int main(int argc, char** argv){
  ...
  list_goals[0] = {1.7, 4, 0, 7};
  list_goals[1] = {5.5, 4, 0, 0};
  list_goals[2] = {5.5, 4, 0, 0};
  list_goals[3] = {5.5, 4, 0, 0};
  list_goals[4] = {5.5, 4, 0, 0};
  ...
  for(int i=0; i<=4; i++){
    ...
    if(ac.getState() == actionlib::SimpleClientGoalState::SUCCEEDED)
      ROS_INFO("Robot 3: Postition %d reached!", i);
    else
  ...
  ROS_ERROR("Robot 3: stop-Sstrategy time_sum %f", time_sum.toSec());
